...
#define CV_STRUCT_ALIGN sizeof(Float32_t)
...
inline  CvPoint3D32f  cvPoint3D32f(Float32_t x, Float32_t y, Float32_t z)
{
	CvPoint3D32f p;
...
inline  CvPoint2D64f  cvPoint2D64f(Float32_t x, Float32_t y)
{
	CvPoint2D64f p;
...
inline  CvPoint3D64f  cvPoint3D64f(Float32_t x, Float32_t y, Float32_t z)
{
	CvPoint3D64f p;
...
void cvAdaptiveThreshold(const IplImage* srcIm, IplImage* dstIm, Float32_t maxValue, int adaptive_method,
	int type, int blockSize, Float32_t delta);
...
CvSeq* cvApproxPoly(const CvSeq* src_seq, int header_size, CvMemStorage* storage, int method, Float32_t eps, int recursive CV_DEFAULT(0));

/****************************************************************************************\
*                            Contour Processing and Shape Analysis                       *
\****************************************************************************************/
Float32_t cvArcLength(const CvSeq* curve, CvSlice slice CV_DEFAULT(CV_WHOLE_SEQ), int is_closed CV_DEFAULT(-1));
//Float32_t cvContourPerimeter( const void* contour )
//{
...
Float32_t cvContourArea(const CvSeq* contour, CvSlice slice CV_DEFAULT(CV_WHOLE_SEQ), int oriented CV_DEFAULT(0));
