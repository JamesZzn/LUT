...
Float32_t Mat_Determinant_3by3_DB(IN Float32_t A[9]);
...
void Transpose_Mat_DB(OUT Float32_t At[9], IN Float32_t A[9], 
	IN Int32_t row, IN Int32_t col);
