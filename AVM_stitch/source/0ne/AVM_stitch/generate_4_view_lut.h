...
void zip_data(IN int shift_altogether, IN Float64_t *image_point, IN Float64_t weight_Float64_t, UInt32_t*p_lut, IN UInt32_t camera_flag);
...
void calculate_world_coordinate(OUT IN Float64_t *world_coordinate, IN int i, IN int j, IN P_Avm_Param_S p_avm_param);
