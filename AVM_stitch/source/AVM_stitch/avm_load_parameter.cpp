	...
	OUT P_Single_View_Crop_Param_S p_single_view_crop_param, IN FILE* p_file)
{
	...
	fgets(buf, MAX_ARRAY_SIZE, p_file);
	fscanf(p_file, "rect_roll_angle: %f",
	...
	IN FILE* p_file)
{
	...
	fscanf(p_file, "plane_expand_fov_h: %f",
		&p_single_view_fr_plane_param->fov_h);
	fgets(buf, MAX_ARRAY_SIZE, p_file);

	fscanf(p_file, "plane_expand_fov_v: %f",
	...
	IN FILE* p_file)
{
	...
	fscanf(p_file, "box_expand_fov_center_h: %f",
		&p_single_view_fr_box_param->fov_h_center);
	fgets(buf, MAX_ARRAY_SIZE, p_file);


	fscanf(p_file, "box_expand_fov_side_h: %f",
		&p_single_view_fr_box_param->fov_h_side);
	fgets(buf, MAX_ARRAY_SIZE, p_file);


	fscanf(p_file, "box_expand_fov_v: %f",
	...
	IN FILE* p_file)
{
	...
	//fscanf(p_file, "%s\n", buf);
	fgets(buf, MAX_ARRAY_SIZE, p_file);
	fscanf(p_file, "trans_y: %f",
		&p_single_view_lr_plane_param->trans_y);
	fgets(buf, MAX_ARRAY_SIZE, p_file);

	fscanf(p_file, "world_width: %f",
		&p_single_view_lr_plane_param->world_width);
	fgets(buf, MAX_ARRAY_SIZE, p_file);

	fscanf(p_file, "world_height: %f",
	...
	IN FILE* p_file)
{
	...
	fscanf(p_file, "plane_width: %f",
		&p_single_view_lr_combine_param->plane_width);
	fgets(buf, MAX_ARRAY_SIZE, p_file);

	fscanf(p_file, "plane_ratio: %f",
		&p_single_view_lr_combine_param->plane_ratio);
	fgets(buf, MAX_ARRAY_SIZE, p_file);

	fscanf(p_file, "valid_angle_range: %f",
	...
	OUT P_Junc_View_4_Config_Common_S p_junc_view_4_config_common, IN FILE* p_file, IN P_Vehicle_Param_S p_vehicle_param, OUT P_Junc_View_4_Param_S p_junc_view_4_param)
{
	...
	fscanf(p_file, "vehilce_length: %f",
		&p_vehicle_param->vehicle_length);
	fgets(buf, MAX_ARRAY_SIZE, p_file);
	fscanf(p_file, "vehilce_width: %f",
		&p_vehicle_param->vehicle_width);
	fgets(buf, MAX_ARRAY_SIZE, p_file);

	p_junc_view_4_param->result_big_param.car_logo_rect;
	...
	fscanf(p_file, "car_logo_rect_init_y: %d",
		&p_junc_view_4_param->result_big_param.car_logo_rect.y);
	fgets(buf, MAX_ARRAY_SIZE, p_file);
	...
	OUT P_Avm_Param_S p_avm_param, IN FILE* p_file)
{
	...
	fprintf(p_file, "car_logo_rect_init_x: %d\n",
		p_avm_param->p_avm_config_param->avm_2d_param.junc_view_4_param.result_big_param.car_logo_rect.x);
	//fgets(buf, MAX_ARRAY_SIZE, p_file);


	fprintf(p_file, "car_logo_rect_init_y: %d\n",
		p_avm_param->p_avm_config_param->avm_2d_param.junc_view_4_param.result_big_param.car_logo_rect.y);
	//fgets(buf, MAX_ARRAY_SIZE, p_file);


	fprintf(p_file, "car_logo_rect_width: %d\n",
		p_avm_param->p_avm_config_param->avm_2d_param.junc_view_4_param.result_big_param.car_logo_rect.width);
	//fgets(buf, MAX_ARRAY_SIZE, p_file);

	fprintf(p_file, "car_logo_rect_height: %d\n",
		p_avm_param->p_avm_config_param->avm_2d_param.junc_view_4_param.result_big_param.car_logo_rect.height);
	//fgets(buf, MAX_ARRAY_SIZE, p_file);
	...
	IN FILE* p_file)
{
	...
	fscanf(p_file, "car_head_length: %f",
	...
	fscanf(p_file, "parallel_range: %f",
		&p_junc_view_3_front_config_common->parallel_range);
	fgets(buf, MAX_ARRAY_SIZE, p_file);

	fscanf(p_file, "curve_range: %f",
		&p_junc_view_3_front_config_common->curve_range);
	fgets(buf, MAX_ARRAY_SIZE, p_file);
	//fscanf(p_file, "\n");
	...
	IN FILE* p_file)
{
	...
	fscanf(p_file, "car_rear_length: %f",
	...
	fscanf(p_file, "parallel_range: %f",
		&p_junc_view_3_rear_config_common->parallel_range);
	fgets(buf, MAX_ARRAY_SIZE, p_file);

	fscanf(p_file, "curve_range: %f",
		&p_junc_view_3_rear_config_common->curve_range);
	fgets(buf, MAX_ARRAY_SIZE, p_file);
	...
	OUT P_Junc_View_4_Param_S p_junc_view_4_param, IN const char* file_name, IN P_Vehicle_Param_S p_vehicle_param)
{
	...
	if (!(p_file_release = fopen("COMM/embed/user_config.txt", "r")))
	{
		printf("cannot be opened\n");

	}
	Load_Junc_View_4_Common_Param_user(
		&p_junc_view_4_param->common_config, p_file_release, p_vehicle_param);
	...
	Load_Junc_View_4_Common_Param_user(
		&p_junc_view_4_param->common_config, p_file_release, p_vehicle_param, p_junc_view_4_param);
	...
	p_result_small_size_param->lut_size[3] = 
		...
		* (p_result_small_size_param->result_image_width 
		- (p_result_small_size_param->car_logo_rect.x 
		+ p_result_small_size_param->car_logo_rect.width));
	...
	, IN P_Vehicle_Param_S p_vehicle_param)
{
	...
	Float32_t pixel_row_dis = (p_vehicle_param->vehicle_length + p_awb_view_param->common_config.front_view_length + p_awb_view_param->common_config.rear_view_length)
		/ (Float32_t)(p_awb_view_param->result_awb_param.result_image_height);//pixel distance
	Float32_t pixel_col_dis= (p_vehicle_param->vehicle_width + p_awb_view_param->common_config.left_view_length + p_awb_view_param->common_config.right_view_length)
		/ (Float32_t)(p_awb_view_param->result_awb_param.result_image_width);//pixel distance
	...
	IN const char* file_name_right)
{
	...
	Load_Single_View_Crop_Param(&p_lr_together_view_param->crop_param_right, p_file_left);
	/******xiazai youyou youyo you ******/
	Load_Single_View_Left_Right_Plane_Expand_Param(
		&p_lr_together_view_param->plane_expand_param_right, p_file_left);

	Load_Single_View_Left_Right_Combine_Expand_Param(
		&p_lr_together_view_param->combine_expand_param_right, p_file_left);

	//Load_Dis_Line_Param(p_dis_line_param_right, p_file_left);
